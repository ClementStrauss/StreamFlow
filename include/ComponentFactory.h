...
public:
    ...
    void static registe(Key const& key, Creator const& creator) {
    ...
    Object static make_ptr(Key const& key) {
...
public:
    ...
    {
        Factory::registe(key, [](){ return std::make_unique<T>(); });
    }
};
...
public:
    ...
    {
        Factory::registe(key, [key](){ return std::make_unique<T>(key); });
    }
};
